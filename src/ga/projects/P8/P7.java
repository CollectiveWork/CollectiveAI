 ...
 */
public class P7 extends GeneticAlgorithm {
    public P7(int m, int n, int it, double uc, double um, boolean elitism, int geneSize) {
    ...
    public static void main(String[] args) {
        ...
        P7 ga = new P7(8, 20, 1500, .8, .333, true, 8);
        ga.setWindow(window);
        ga.drawDataset();
